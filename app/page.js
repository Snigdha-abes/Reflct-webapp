...
import { BarChart2, Book, Calendar, ChevronRight, FileText, Lock, Sparkle } from "lucide-react";
  ...
  return (
    <div className="relative container mx-auto px-4 pt-16 pb-16">
      <div className="max-w-5xl mx-auto text-center space-y-8">
        <h1 className="text-5xl md:text-7xl lg:text-8xl mb-6 gradient-title">Your Space to Reflect.<br/> Your Space to Create.</h1>
        <p className="text-lg md:text-xl text-orange-800 mb-8">
          Capture your thoughts, track your moods, and reflect on your journey on your journey in a beautiful, secure space.
        </p>
        ...
        <div className="flex justify-center gap-4">
          ...
          <Button variant='journal' className='px-8 py-6 rounded-full flex items-center gap-2'>
            Start Writing <ChevronRight className="h-5 w-5"/></Button></Link>
      ...
      <section id="features" className="mt-24 md:grid-cols-2 lg:grid-cols-3 gap-8 md:grid">
      ...
      <div className="space-y-24 mt-24">
        <div className="grid md:grid-cols-2 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-lg text-orange-700">Express yourself fully with the powerful editor featuring:</p>
        ...
        <div className="mt-24">
          ...
          <Accordion type="single" collapsible className="max-auto w-full">
            {faqs.map((faq,index)=>{
                return(
      ...
      <div className="mt-24">
        <Card className='bg-gradient-to-r from-orange-100 to amber-100'>
          <CardContent className='p-12 text-center'>
            <h2>
              Start Reflct-ing on Your Jourey Today
            </h2>
            <p className="text-lg text-orange-700 mb-8 max-w-2xl mx-auto">
              Join the thousands of people who have already discovered the power of digital journaling with us.
            </p>
            <Link href="/dashboard">
